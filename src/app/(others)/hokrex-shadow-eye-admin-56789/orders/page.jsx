  ...
  return (
    ...
    >
      <motion.div
        ...
        animate={{ y: 0 }}
        id="scroll-none"
        className="relative flex h-[600px] w-full max-w-[1000px] flex-col  overflow-y-scroll rounded-[10px] border bg-white pb-5"
      >
        <div className="sticky left-0 top-0 z-[50] flex w-full items-center justify-between border-b border-black bg-white px-2 py-1 pl-3">
          ...
          <div className="flex gap-3">
            ...
            <span
              ...
              className="cursor-pointer [&_rect]:stroke-none [&_svg]:h-[40px] [&_svg]:w-[40px]"
            >
              {cross}
            </span>
          </div>
        ...
        <div className="flex flex-col px-8 ">
          ...
          <div className="flex flex-col gap-3 border-t border-[#E5E5E5] py-2">
            ...
            <div className="flex flex-col gap-2">
              <span className="text-[16px] font-[700]">Checkout Files :</span>
              <div className="flex-center w-full flex-col">
                {order.checkoutFiles?.map(
                  (it) =>
                    it.includes("/") && (
                      <Image
                        src={it}
