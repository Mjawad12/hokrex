...
const CustomCheckbox = ({ text, st, fontSize }) => {
  ...
  return (
    <label
      ...
      className={`w-full flex items-center justify-start cursor-pointer text-[1.05rem] gap-4 larger:text-[0.8rem] small:text-[0.9rem] 
