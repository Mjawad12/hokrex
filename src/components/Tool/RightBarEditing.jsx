...
function RightBarEditing({
  ...
  return (
    <motion.div
      ...
      id="smSCroll"
      className="absolute right-0 top-[3.05rem] z-50 flex h-[calc(100vh-50px)] w-full max-w-[320px] select-none flex-col overflow-x-visible overflow-y-scroll bg-darkMid p-3 px-3.5"
    >
